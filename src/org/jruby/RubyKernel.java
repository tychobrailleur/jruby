...
public class RubyKernel {
    ...
    @JRubyMethod(name = "__dir__", compat = RUBY1_9)
    public static IRubyObject current_dir(ThreadContext context, IRubyObject self) {
        if (context.getFile() == null) return context.runtime.getNil();
        
        String scriptDirectory = new File(context.getFile()).getParent();
        if (scriptDirectory == null) return context.runtime.getNil();
        return context.runtime.newString(scriptDirectory);
    }
}
